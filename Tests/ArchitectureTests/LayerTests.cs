...
namespace ArchitectureTests
{
    public class LayerTests : BaseTest
    {
        ...
        private static readonly IObjectProvider<IType> InfrastructureLayer =
            Types().That().ResideInAssembly(InfrastructureCommonAssembly)
            .Or().ResideInAssembly(InfrastructureCacheAssembly)
            .Or().ResideInAssembly(InfrastructureDataAccessAssembly)
            .Or().ResideInAssembly(InfrastructureLoggingAssembly)
